...
class donasi:
    def __init__(self,window,id_dntr):
        ...
        Nominal_input = Entry(inputframe,width = 40).place(x=30,y=40,height=30)
        ...
        cmb_nama_company =ttk.Combobox(inputframe,values=donasi_uang.getBadanAmal(),state='readonly')
        cmb_nama_company.place(x=30,y=120,width=320,height=30)
        cmb_nama_company.current(0)

        btn_donasi = Button(inputframe,text="Donasikan",font=("times new roman",12,"bold"),bg="green",fg="white").place(x=150,y=200)
...
class donasi_barang:
    def __init__(self,window,id_dntr):
        ...
        cmb_nama_company =ttk.Combobox(inputframe,values=("Baju","Makanan","Kebutuhan Pokok","Buku","other"),state='readonly')
        ...
        btn_donasi = Button(inputframe,text="Donasikan",font=("times new roman",12,"bold"),bg="green",fg="white").place(x=150,y=300)
