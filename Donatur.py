...
class donatur:
    def __init__(self,window,id_dntr):
        ...
        title=Label(self.window,text = "Selamat Datang",font=("times new roman",40,"bold"),bg = "green",fg = "white").place(x = 0, y = 0,relwidth = 1,height = 70)

        LeftMenu = Frame(self.window,bd=2,relief=RIDGE, bg="white")
        LeftMenu.place(x=0,y=70,width=200,height=900)

        lbl_Menu = Label(LeftMenu,text="MENU",font=("times new roman",20,"bold"),bd =3,bg="blue",fg="white").pack(side=TOP,fill=X)
